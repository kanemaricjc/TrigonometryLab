        ...
        try {    
            ...
            double angle2=input.nextDouble();
                ...
                double normalization = angle2 % 360; //a value between 0 and 360 degrees
                    ...
                    String quadrant; //i string nato ang quadrant daan so we can just substitute it later para mas dali.
                    if (normalization > 0 && normalization < 90 ) { //angles that lie on quadrant 1 ranges from 1-89
                        ...
                        quadrant="Quadrant 4.";
                    } else { //the possible values for else is 0,90,180, and 270, which all lie on an axis.
                        quadrant="an axis."; //depende kung unsa ang value sa degrees, the String quadrant changes its output.
                    }
                
                    String signofsin;
                    String signofcos;
                    String signoftan; // same ra sa gibuhat nato sa quadrant, we are using string para mas musayon.
                    if ( quadrant.equals("Quadrant 1.") ) { //originally mag gamit unta kog "quadrant==("Quadrant 1.")" para depende sa kung unsa ang output sa quadrant pero nag recommend ang IDE na i quadrant.equals daw so mao nalang akong gigamit
                        signofsin = "positive.";
                        signofcos = "positive.";
                        signoftan = "positive.";
                    } else if ( quadrant.equals("Quadrant 2.") ) { 
                        signofsin = "positive.";
                        signofcos = "negative.";
                        signoftan = "negative.";
                    } else if ( quadrant.equals("Quadrant 3.") ) {
                        signofsin = "negative.";
                        signofcos = "negative.";
                        signoftan = "positive.";
                    } else if ( quadrant.equals("Quadrant 4.") ) { //para ani sa ila gi check nako gamit 89, 91, 181, and 359 respectively to check for signs for quadrant 1, 2, 3, and 4.
                        signofsin = "negative.";
                        signofcos = "positive.";
                        signoftan = "negative.";
                    } else {
                        signofsin = "depends on what axis it lies on.";
                        signofcos = "depends on what axis it lies on.";
                        signoftan = "depends on what axis it lies on."; //depende ra sya if it lies on the positive/negative x axis or positive/negative y axis.
                    }
            ...
            double elements = input.nextDouble();
                ...
                double angleA = 0, angleB = 0; // same here but for the angles instead
                    ...
                    if ( elements == 1 ) { //if elements is 1
                        ...
                        System.out.println("What is its length?");
                            double side2value=input.nextDouble();
                                ...
                                if ( side1 == 'A' || side1 == 'a' ) { //depende kung unsa na side ang given sa side 1 nato
                                    sideA = side1value;
                                } else if ( side1 == 'B' || side1 == 'b' ) {
                                    sideB = side1value;
                                } else if ( side1 == 'C' || side1 == 'c' ) { //gamit ang kaning tulo kay gitagaan natog value ang side 1 dependent kung unsa sya na side ang given
                                    sideC = side1value;
                                }
                                
                                if ( side2 == 'A' || side2 == 'a' ) { //same ra diria sa side 2 
                                    sideA = side2value;
                                } else if ( side2 == 'B' || side2 == 'b' ) {
                                    sideB = side2value;
                                } else if ( side2 == 'C' || side2 == 'c' ) { //same ra diria sa taas
                                    sideC = side2value;
                                }
                    ...
                    } else if ( elements == 2 ) { //if the choice chosen was 2
                        ...
                        double angleelementsdeg = input.nextDouble();
                            if ( angleelementsdeg<=0 || angleelementsdeg>=90 ) {
                                ...
                                if ( sideelements == 'A' || sideelements == 'a' ) { //depende kung unsa na side ang given sa side 1 nato,same sa taas
                                    sideA = sideelementsvalue;
                                    angleA = angleelementsdeg;
                                } else if ( sideelements == 'B' || sideelements == 'b' ) {
                                    sideB = sideelementsvalue;
                                    angleB = angleelementsdeg;
                                } else if ( sideelements == 'C' || sideelements == 'c' ) { //gamit ang kaning tulo kay gitagaan natog value ang side 1 dependent kung unsa sya na side ang given
